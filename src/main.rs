...
// }
// use pump::pump_simulation::{FluidType, Pump, PumpOperatingPoint};
fn main() {
    ...
    // println!("Расход теплоносителя:      {:.1} м3/ч", flow_rate_m3_h);
    ...
    // 1. Инициализируем стандартный насос 1К50-32-125
        // У этого насоса в кратком паспорте нет кавитационного запаса,
        // модель рассчитает его автоматически (он составит порядка 3.5 метров)
